...
filename = "/home/jovyan/work/data/bank-full.csv"
...
#
# spark-submit --master local[*] /home/jovyan/work/mlflow_example.py --maxBinsVal 32 --maxDepthVal 5
# mlflow server --default-artifact-root /home/jovyan/work/mlflow/artifacts/ --host 0.0.0.0 &
#
# spark-submit --master local[*] /home/jovyan/work/code/mlflow_example.py 16 3 model_run  --spark_autolog True
# spark-submit --master local[*] /home/jovyan/work/code/mlflow_example.py 32 5 model_run  --spark_autolog True
# spark-submit --master local[*] /home/jovyan/work/code/mlflow_example.py 16 5 model_run  --spark_autolog True
#

# Docker 기반 Installation
#
# docker run -it -p 5000:5000 -v e:/mlflow/demo/:/home/jovyan/work jupyter/pyspark-notebook:latest bash
#
# pip install mlflow
# or conda install -c conda-forge mlflow
#

# 필요한 경우 postgresql 와 연동
# sudo apt-get update
#
...
# --port 5000 &
#
# Postgre SQL이 설치된 경우에 대한 MLFLOW
